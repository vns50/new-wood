...
new Swiper('.slider-introducing__body', {
	...
	pagination: {
		...
		bulletClass: "slider-introducing-bullet",
		bulletActiveClass: "slider-introducing-bullet-active",
		clickable: true,
	},
	on: {
		lazyImageReady: function () {
...
//========================================================================================================================================================
if (document.querySelector('.silon-slider__block')) {
	new Swiper('.silon-slider__block', {
		observer: true,
		observeParents: true,
		slidesPerView: 'auto',
		spaceBetween: 25,
		...
		// Dotts
		pagination: {
			el: '.silon-slider__dotts',
			bulletClass: "swiper-silon-bullet",
			bulletActiveClass: "swiper-silon-bullet-active",
			clickable: true,
		},
		// Arrows
		navigation: {
			nextEl: '.slider-arrows .slider-arrows_next',
			prevEl: '.slider-arrows .slider-arrows_prev',
		}
	});
}
//========================================================================================================================================================
...
function mapInit(n = 1) {
	...
	var locations = [
		[new google.maps.LatLng(50.454660, 30.523800)],
		[new google.maps.LatLng(50.454660, 30.523800)],
		[new google.maps.LatLng(50.454660, 30.523800)],
		[new google.maps.LatLng(50.454660, 30.523800)],
	]
